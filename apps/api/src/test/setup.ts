...
vi.mock("../db", () => ({
  db: {
    query: {
      ...
      renderSignals: { findFirst: vi.fn(), findMany: vi.fn() },
      renderBehavior: { findFirst: vi.fn(), findMany: vi.fn() },
      renderOutcomes: { findFirst: vi.fn(), findMany: vi.fn() },
      cutlistEdits: { findFirst: vi.fn(), findMany: vi.fn() },
      userTasteProfiles: { findFirst: vi.fn(), findMany: vi.fn() },
      behaviorCorpusEntries: { findFirst: vi.fn(), findMany: vi.fn() },
    },
