            ...
            "properties": {
                ...
                "section_markers": {
                    ...
                    "items": {
                        ...
                        "required": ["name", "start_s", "end_s"],
                    },
                },
                "color_grade_ref": {"type": "string"},
                "aspect_ratio": {"type": "string"},
            },
            "required": ["total_duration_s", "tempo_bpm", "time_signature", "energy_curve", "section_markers", "aspect_ratio"],
        },
        "slots": {
            "type": "array",
            "items": {
                ...
                "properties": {
                    ...
                    "section": {"type": "string"},
                    "transition_in": {"type": "string", "enum": ["hard_cut", "fade", "dissolve", "wipe_left", "wipe_right", "wipe_up", "wipe_down", "circle_open", "slide_up", "slide_down", "slide_left", "slide_right", "pixelize", "hlslice", "flash", "whip"]},
                    "transition_out": {"type": "string", "enum": ["hard_cut", "fade", "dissolve", "wipe_left", "wipe_right", "wipe_up", "wipe_down", "circle_open", "slide_up", "slide_down", "slide_left", "slide_right", "pixelize", "hlslice", "flash", "whip"]},
                    "target_shot_type": {"type": "string", "enum": ["extreme_wide", "wide", "medium_wide", "medium", "medium_close_up", "close_up", "extreme_close_up", "insert", "establishing"]},
                    "subject_hint": {"type": "string"},
                    "motion_hint": {"type": "string", "enum": ["static", "slow_push", "fast_push", "pull", "pan_left", "pan_right", "tilt_up", "tilt_down", "whip", "zoom_in", "zoom_out", "dolly_in", "dolly_out", "tracking", "handheld", "gimbal", "drone", "crane", "speed_ramp", "freeze"]},
                ...
                "required": ["index", "start_s", "duration_s", "beat_index", "section", "transition_in", "transition_out", "target_shot_type", "subject_hint", "motion_hint", "energy_level", "required_tags", "avoid_tags"],
            },
        },
        "overlays": {
            "type": "array",
            "items": {
                ...
                "required": ["text", "start_s", "end_s", "position", "font", "font_size_px", "color", "animation"],
            },
        },
    },
